...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(
        package="novamob_description"
    ).find("novamob_description")
    # Messages are from: https://navigation.ros.org/setup_guides/sensors/setup_sensors.html#launching-nav2
    diff_drive_loaded_message = "Spawn status: SpawnEntity: Successfully spawned entity [novamob]"
    ...
    return launch.LaunchDescription(
        [
            DeclareLaunchArgument(
                "params_file",
                default_value=[FindPackageShare("novamob_description"), "/config/nav2_params_novamob.yaml"],
