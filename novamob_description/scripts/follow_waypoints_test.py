...
def main():
    ...
    parser.add_argument('--sim_env', type=str, default='gazebo_classic', help='Simulation environment (gazebo_fortress or gazebo_classic)')
    ...
    while not navigator.isTaskComplete():
        ...
        if feedback and feedback.current_waypoint == 1 and not spawned_1 and args.dynamic_obstacles == 'true':
            spawn_object("obstacle_cube_1", x=0.5, y=-0.5, z=0.25, sim_env=args.sim_env)
            spawned_1 = True
